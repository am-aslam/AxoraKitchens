    ...
    return (
        ...
        >
            <div className="block relative h-[250px] overflow-hidden">
                <Link href={`/categories/${product.slug}`} className="absolute inset-0 z-10" />
            ...
            <div className="p-6 flex flex-col flex-1 relative z-20 bg-bg-secondary">
                ...
                <p className="text-sm text-text-muted mb-6 leading-relaxed flex-1 line-clamp-3">{product.desc}</p>
                ...
                >
                    ...
                    <ArrowRight className={`w-4 h-4 transition-transform duration-300 group-hover:translate-x-1 ${direction === 'rtl' ? 'rotate-180' : ''}`} />
                </Link>
            </div>
        </motion.div>
    );
    ...
    const products = [
        {
            ...
            image: heroImage,
            images: [heroImage, livingImage, heroImage]
        },
        {
            id: 'countertops',
            slug: 'countertops',
            ...
            image: marbleImage,
            images: [marbleImage, marbleImage, marbleImage]
        },
        {
            id: 'washCounters',
            slug: 'wash-counters',
            ...
            image: bathImage,
            images: [bathImage, bathImage, bathImage]
        },
        {
            id: 'wardrobes',
            slug: 'wardrobes',
    ...
    return (
        <section className="py-32 bg-bg-primary" id="products">
            <div className="max-w-[1400px] mx-auto px-6">
                ...
                >
                    <h2 className="text-4xl font-bold mb-4 tracking-tight text-inherit">{t.title}</h2>
                ...
                >
                    {products.map((product) => (
                        <ProductCard key={product.id} product={product} t={t} direction={direction} />
                    ))}
                </motion.div>
            </div>
            ...
            <div className="max-w-[1400px] mx-auto px-6">
                ...
                >
                    <div className="max-w-2xl">
                        <h2 className="text-3xl md:text-4xl font-bold mb-4 tracking-tight">{t.customTitle || "Need a Custom Solution?"}</h2>
                        <p className="text-bg-primary/80 text-lg">
                            {t.customDesc || "Contact our design team to create a bespoke interior solution tailored to your space."}
                        </p>
                    </div>
