            ...
            <div className="max-w-[1400px] mx-auto px-6">
                <div className="grid grid-cols-1 md:grid-cols-[1.5fr_1fr_1fr_1fr] gap-10 mb-16">
                    <div className="col-span-1 md:col-span-1 md:col-start-auto footer-brand">
                        <h2 className="text-text-main text-3xl font-bold mb-6 tracking-tight">AxoraKitchens</h2>
                    ...
                    <div>
                        <h4 className="text-text-main text-base font-bold mb-6 uppercase tracking-wider">{t.connect}</h4>
                ...
                <div className="border-t border-border pt-10 text-sm text-text-muted flex flex-col md:flex-row justify-between items-center text-center md:text-left gap-4">
                    ...
                    <div className="flex gap-5">
                        <Link href="#" className="hover:text-text-main transition-colors duration-300">{t.privacy}</Link>
                        <Link href="#" className="hover:text-text-main transition-colors duration-300">{t.terms}</Link>
                    </div>
                </div>
            </div>
        </footer>
